...
#duplicate numbers
run_test_args "slow" "1 1 1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
#sorted
run_test_args "slow" "1 2 3 4 5 6 7 8 9" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
#reverse sorted
run_test_args "slow" "9 8 7 6 5 4 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 36"
#sorted w negatives
run_test_args "slow" "-2 -1 0 1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
#reverse sorted w negatives
run_test_args "slow" "2 1 0 -1 -2" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
#general functionality
run_test_args "slow" "3 1 4 1 5" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "slow" "2 7 1 8 2" "Enter sequence of integers, each followed by a space: Number of inversions: 4"
#multiple digit numbers
run_test_args "slow" "8675309 399 696969 69 420 123 6969 90210" "Enter sequence of integers, each followed by a space: Number of inversions: 15"
              #0 +     1 + 1 +    3 +2 + 4 + 2 +  2 = 15
#15 numbers
run_test_args "slow" "29 88 -18 -41 -35 -97 95 -14 43 59 -28 1 84 -53 -28" "Enter sequence of integers, each followed by a space: Number of inversions: 55"
                     #0 +0  +2  +3  +3  +5 +0  +3 +2 +2  +7 +5+2  +12 +9 = 55
#100000 numbers
...
#duplicate numbers
run_test_args "" "1 1 1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
#sorted
run_test_args "" "1 2 3 4 5 6 7 8 9" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
#reverse sorted
run_test_args "" "9 8 7 6 5 4 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 36"
#sorted w negatives
run_test_args "" "-2 -1 0 1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
#reverse sorted w negatives
run_test_args "" "2 1 0 -1 -2" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
#general functionality
run_test_args "" "3 1 4 1 5" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "" "2 7 1 8 2" "Enter sequence of integers, each followed by a space: Number of inversions: 4"
#multiple digit numbers
run_test_args "" "8675309 399 696969 69 420 123 6969 90210" "Enter sequence of integers, each followed by a space: Number of inversions: 15"
              #0 +     1 + 1 +    3 +2 + 4 + 2 +  2 = 15
#15 numbers
run_test_args "" "29 88 -18 -41 -35 -97 95 -14 43 59 -28 1 84 -53 -28" "Enter sequence of integers, each followed by a space: Number of inversions: 55"
                     #0 +0  +2  +3  +3  +5 +0  +3 +2 +2  +7 +5+2  +12 +9 = 55
#100000 numbers
